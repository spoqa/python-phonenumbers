...
PHONE_METADATA_KR = PhoneMetadata(id='KR', country_code=82, international_prefix='00(?:[124-68]|[37]\\d{2})',
    general_desc=PhoneNumberDesc(national_number_pattern='[1-7]\\d{3,9}|8\\d{8,9}', possible_number_pattern='\\d{4,11}'),
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='80\\d{7,8}', possible_number_pattern='\\d{9,10}', example_number='801234567'),
